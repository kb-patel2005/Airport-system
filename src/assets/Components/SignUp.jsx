  ...
  return (
    <section>
      <Helmet>
        ...
        <meta
          name="description"
          content="Create your account on flight System to booking flights, manage flight bookings, and enjoy real-time flight seat map and flight tracking."
        />

        <meta property="og:title" content="Book Flights Online | Live Seat Updates & Tracking" />
        <meta property="og:description" content="Create your account on flight System to booking flights, manage flight bookings, and enjoy real-time flight seat map and flight tracking." />
        ...
        <meta name="twitter:description" content="Create your account on flight System to booking flights, manage flight bookings, and enjoy real-time flight seat map and flight tracking." />
